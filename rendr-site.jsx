  ...
  return (
    <main className="pt-24">
      ...
      <section id="work" className="max-w-7xl mx-auto px-6 md:px-10 py-32 border-t border-neutral-900">
        ...
        <div className="relative -mx-6 md:-mx-10 overflow-hidden hide-scrollbar">
          ...
          <div className="flex gap-6 w-max py-8 px-6 md:px-10 animate-scroll">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-10 pt-16 pb-24">
        <div className="fade-up">
          ...
          <div className="mt-14 max-w-4xl mx-auto text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 items-center justify-center">
              <button data-tf-popup="s1hRa4kO" className="neon-btn px-7 py-4 rounded-full text-base font-medium flex items-center gap-3 whitespace-nowrap">
                Apply to create
                <span>→</span>
              </button>
              <span className="font-mono text-xs text-neutral-500">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-10 py-32">
        <div className="border border-neutral-900 rounded-3xl p-10 md:p-20 text-center relative overflow-hidden grid-bg">
          ...
          <div className="relative">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 items-center justify-center">
              <button data-tf-popup="s1hRa4kO" className="neon-btn px-8 py-4 rounded-full text-base font-medium flex items-center gap-3">
                Start application
                <span>→</span>
              </button>
              <a
