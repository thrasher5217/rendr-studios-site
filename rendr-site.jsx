...
function CreatorView({ openFaq, setOpenFaq }) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Varies by campaign. Minimum is typically 5 videos/week when you're active. Top creators ship 15-20/week. We tell you the target before you commit — no surprises.",
    },
    {
      q: "How do I get paid?",
