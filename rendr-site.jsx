        ...
        <div className="mt-24 border border-neutral-900 rounded-3xl overflow-hidden grid-bg">
          <div className="grid grid-cols-3 divide-x divide-neutral-900">
            <div className="p-8 md:p-10">
              ...
              <div className="font-serif-display text-6xl md:text-7xl">15+</div>
      ...
      <section id="work" className="max-w-7xl mx-auto px-6 md:px-10 py-32 border-t border-neutral-900">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          {sampleWork.map((item, i) => (
            <div
              key={i}
              className={`aspect-[9/16] rounded-2xl border border-neutral-900 relative overflow-hidden ${item.video ? "" : "thumbnail-placeholder hover-lift group cursor-pointer"}`}
            >
              {item.video ? (
                <>
                  <iframe
                    ...
                    allowFullScreen
                  />
                  <div className="absolute bottom-0 left-0 right-0 z-20 pointer-events-none bg-gradient-to-t from-neutral-950/90 via-neutral-950/40 to-transparent px-5 pb-5 pt-10">
                    <div className="flex items-center gap-2 mb-1">
                      <div className="font-mono text-[10px] uppercase tracking-widest text-neutral-400 border border-neutral-700 px-2 py-0.5 rounded bg-neutral-950/60">
                        {item.platform}
                      </div>
                    </div>
